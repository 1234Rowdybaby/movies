...
BOT_TOKEN = environ.get('BOT_TOKEN', '6878904164:AAGiOYVtLe4c-Rmkn1HhGLMa6YV4fckJo9c')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/5dfcdfe95d28a9ebc9dad-90993b348287fc6dea.jpg')).split()
...
DELETE_TIME = int(environ.get('DELETE_TIME', 3))
